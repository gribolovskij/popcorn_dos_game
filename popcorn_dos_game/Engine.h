...
private:
	...
	HPEN Letter_Pen, Purple_Brick_Pen, Blue_Brick_Pen, Platform_Circle_Pen, Platform_Inner_Pen, Arc_Pen,  Border_Blue_Pen, Border_White_Pen;
	HBRUSH Purple_Brick_Brush, Blue_Brick_Brush, Platform_Circle_Brush, Platform_Inner_Brush, Arc_Brush,  Border_Blue_Brush, Border_White_Brush;
